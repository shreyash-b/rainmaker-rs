...
pub fn mqtt_init() -> MqttClient<'static> {
    ...
    let tls_certs = TLSconfiguration {
...
pub fn mqtt_subscribe(client: &mut MqttClient, topic: &str) {
    client.subscribe(topic, &QoSLevel::AtMostOnce);
}
